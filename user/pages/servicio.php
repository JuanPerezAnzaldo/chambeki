...
$sql = "SELECT s.titulo, s.descripcion, s.monto, u.nombre AS freelancer, c.nombre_categoria 
        ...
        WHERE (s.titulo LIKE :busqueda OR s.descripcion LIKE :busqueda OR c.nombre_categoria LIKE :busqueda)";

$termino = '%' . $oficio_buscado . '%';
$sentencia = $conexion->prepare($sql);
$sentencia->execute([':busqueda' => $termino]);
$resultados = $sentencia->fetchAll(PDO::FETCH_ASSOC);
?>

<!-- Buscador en la parte superior del listado, manteniendo tus datos -->
